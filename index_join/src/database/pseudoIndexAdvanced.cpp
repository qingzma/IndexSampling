...
void PseudoIndexAdvancedBuilder::Build(){
...
int64_t PseudoIndexAdvancedBuilder::getCardinality() {
    return m_cadinality;
}

void PseudoIndexAdvancedBuilder::Sample(int sampleSize) {
...
void PseudoIndexAdvancedBuilder::Sample(int sampleSize, JoinOutputColumnContainer joinOutputColumnContainer) {
...
PseudoIndexAdvancedBuilder::JoinIndexItem PseudoIndexAdvancedBuilder::getJoinIndexItem(int64_t num) {
    int l = 0;
...
JoinIndexItemIndexes PseudoIndexAdvancedBuilder::getJoinIndexItemIndexes(PseudoIndexAdvancedBuilder::JoinIndexItem joinIndexItem) {
...
void PseudoIndexAdvancedBuilder::fetchJoinTuples(std::string outfile) {
...
void PseudoIndexAdvancedBuilder::fetchJoinTuples(std::string outfile, JoinOutputColumnContainer joinOutputColumnContainer) {
    std::ofstream output_file(outfile, std::ios::out | std::ofstream::app);
...
std::string PseudoIndexAdvancedBuilder::fetchJoinTupleRandom(JoinIndexItem joinIndexItem) {
    std::string outStr= "";
...
std::string PseudoIndexAdvancedBuilder::fetchJoinTupleUsingIndex(JoinIndexItemIndexes joinIndexItemIndexes, JoinOutputColumnContainer joinOutputColumnContainer) {
    std::string outStr="";
...
std::string PseudoIndexAdvancedBuilder::fetchJoinTupleUsingIndex(JoinIndexItemIndexes joinIndexItemIndexes,
